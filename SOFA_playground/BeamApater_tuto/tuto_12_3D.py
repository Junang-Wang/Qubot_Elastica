...
def createScene(rootNode):
    ...
    BeamModel.addObject('RegularGridTopology', name='MeshLines', drawEdges=False, 
                                    ...
                                    p0=[0,0,0])
    BeamModel.addObject('MechanicalObject', showIndices=False, name='Instrument_DOFs', template='Rigid3d', ry=-90)
    ...
    Env.addObject('MeshOBJLoader', name = 'env_mesh', filename= 'phantom.obj',triangulate=True, scale = 1, flipNormals='1')
    ...
    Env.addObject('MechanicalObject', name = 'env_DOFs', position =[0,0,400], scale=3, ry=90)
    ...
    Env.addObject('OglModel', name='visu_env', src='@env_mesh', color=[1,0,0,0.3], scale=3, ry=90)
