...
def createScene(rootNode):
    ...
    topoLines.addObject('RodStraightSection', name ='StraightSection',
                         youngModulus= 10000, nbEdgesCollis = 40, nbEdgesVisu = 220, length = 600)
    topoLines.addObject('RodSpireSection', name ='SpireSection',
                         youngModulus= 10000, nbEdgesCollis = 10, nbEdgesVisu = 80, length = 400, spireDiameter=4000, spireHeight=0)
